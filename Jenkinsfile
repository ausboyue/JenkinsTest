	...
	stages {
		...
		stage('生成 APK 二维码') {
			steps {  	
				...
				bat "java -jar D:\\Jenkins\\libs\\qr.jar url=http://192.168.5.30:80/automationtest/script/ EhaiCarServiceAPK/${params.Environment}/ehaicarservice_${BUILD_TIMESTAMP}.apk image=ehaicarservice_${BUILD_TIMESTAMP}.jpg save=./"
